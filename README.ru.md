...
Плагин для NodeBB, который позволяет пользователям входить и регистрироваться через VK OAuth 2.0. Идеален для русскоязычных сообществ.
...
1. Перейдите в **Панель администратора** → **Плагины** → **NodeBB Yandex SSO**
2. Введите **Client ID**
